...
<script type="text/babel" src="${contextRoot}/js/employee/editMyProfile.js"></script>
<script type="text/babel">ReactDOM.render(<EditMyProfile />, document.getElementById('root'));</script>
</body>
</html>