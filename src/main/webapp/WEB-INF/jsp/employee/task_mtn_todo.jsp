...
<script type="text/babel" src="${contextRoot}/js/employee/taskMtnAssignmentEmployee.js"></script>
<script type="text/babel">ReactDOM.render(<TaskMtnAssignmentEmployee />, document.getElementById('root'));</script>
</body>
</html>