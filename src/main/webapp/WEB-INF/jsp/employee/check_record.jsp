...
<script type="text/babel" src="${contextRoot}/js/employee/checkRecord.js"></script>
<script type="text/babel" src="${contextRoot}/js/employee/components/pagination.js"></script>
<script type="text/babel">ReactDOM.render(<CheckRecord />, document.getElementById('root'));</script>
</body>
</html>