...
<!-- import 自己的 CSS -->
<link rel="stylesheet" href="${contextRoot}/css/employee.list.css">
</head>
<body>
	...
	<div class="flex">
		<div
			class="min-h-screen flex flex-col flex-none w-64 flex-shrink-0 antialiased bg-gray-50 text-gray-800">
			...
			<div
				...
				<div class="overflow-y-auto overflow-x-hidden flex-grow"
					...
					<ul class="flex flex-col py-4 space-y-1">
						...
						<li><a href="#"
							...
							</span> <span class="ml-2 text-sm tracking-wide truncate">Dashboard</span>
						</a></li>
						<li><a href="#"
							class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
								<span class="inline-flex justify-center items-center ml-4">
							...
							</span> <span class="ml-2 text-sm tracking-wide truncate">Inbox</span> <span
						...
						<li><a href="#"
							...
							</span> <span class="ml-2 text-sm tracking-wide truncate">Messages</span>
						</a></li>
						<li><a href="#"
							class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
								<span class="inline-flex justify-center items-center ml-4">
							...
							</span> <span class="ml-2 text-sm tracking-wide truncate">Notifications</span>
								<span
						...
						<li><a href="#"
							...
							</span> <span class="ml-2 text-sm tracking-wide truncate">Available
									Tasks</span>
						</a></li>
						<li><a href="#"
							class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
							...
							</span> <span class="ml-2 text-sm tracking-wide truncate">Clients</span>
								<span
						...
						<li><a href="#"
							...
							</span> <span class="ml-2 text-sm tracking-wide truncate">Profile</span>
						</a></li>
						<li><a href="#"
							class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
								<span class="inline-flex justify-center items-center ml-4">
                ...
                <path stroke-linecap="round" stroke-linejoin="round"
							...
							</span> <span class="ml-2 text-sm tracking-wide truncate">Settings</span>
						</a></li>
						<li><a href="#"
							class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
								<span class="inline-flex justify-center items-center ml-4">
							...
							</span> <span class="ml-2 text-sm tracking-wide truncate">Logout</span>
						</a></li>
					</ul>
				...
				<div class="flex items-center p-2 mt-12 space-x-4 justify-self-end">
					...
					<div>
						...
						<span class="flex items-center space-x-1"> <a
							rel="noopener noreferrer" href="#"
							class="text-xs hover:underline dark:text-gray-400">View
								profile</a>
						</span>
					</div>
				</div>
		...
		<div class="grow antialiased bg-gray-50 text-gray-800">1234153</div>
	</div>
