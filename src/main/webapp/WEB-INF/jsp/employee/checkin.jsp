...
<script type="text/babel" src="${contextRoot}/js/employee/checkInOut.js"></script>
<script type="text/babel">ReactDOM.render(<CheckInOut />, document.getElementById('root'));</script>
</body>
</html>