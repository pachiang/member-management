...
<script type="text/babel" src="${contextRoot}/js/employee/leaveForm.js"></script>
<script type="text/babel">ReactDOM.render(<LeaveForm />, document.getElementById('root'));</script>
</body>
</html>