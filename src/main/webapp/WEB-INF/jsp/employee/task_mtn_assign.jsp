...
<script type="text/babel" src="${contextRoot}/js/employee/taskMtnAssignmentManager.js"></script>
<script type="text/babel">ReactDOM.render(<TaskMtnAssignmentManager />, document.getElementById('root'));</script>
</body>
</html>